...
# Loading the data
native_sq = np.loadtxt('../csv/native_square.csv')
native_r1 = np.loadtxt('../csv/native_rect1.csv')
native_r2 = np.loadtxt('../csv/native_rect2.csv')

cublas_sq = np.loadtxt('../csv/cublas_square.csv')
cublas_r1 = np.loadtxt('../csv/cublas_rect1.csv')
cublas_r2 = np.loadtxt('../csv/cublas_rect2.csv')
