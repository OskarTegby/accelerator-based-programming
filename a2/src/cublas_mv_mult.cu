...
int main(int argc, char **argv)
{
  ...
  myfile.open("/home/oskart/abp/a2/csv/cublas_square.csv");
  ...
  {
  myfile.open("/home/oskart/abp/a2/csv/cublas_rect1.csv");
    n = 10000;
  ...
  {
  myfile.open("/home/oskart/abp/a2/csv/cublas_rect2.csv");
    m = 16384;
    for (n = N_min; n <= N_max; n = (1 + n * 1.1))
    {
        // round up to nearest multiple of 8
